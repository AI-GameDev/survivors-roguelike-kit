...
namespace RGame.RoguelikeKit
{
    ...
    ///     Takes a GameSceneSO of the location or menu that needs to be loaded, and a bool to specify if a loading screen
    ///     needs to display.
    /// </summary>
    [CreateAssetMenu(menuName = "RGame/RoguelikeKit/Events/Scene/Load Event Channel")]
